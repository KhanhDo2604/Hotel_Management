...
export default function BookingList() {
  ...
  return (
    <div style={{}}>
      <div style={{ marginTop: "2.2rem" }} className={styles.containerGrid}>
        ...
        <div className={styles.middles} ref={menuRef}>
          ...
          >
            ...
            <p ref={guestRef} style={{ fontWeight: "bold" }}>
              {guest} Guests
            </p>
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <button className={styles.btnLeft}>Filter</button>
          <button className={styles.btnLeft} onClick={converPage}>
            Book
          </button>
        </div>
      </div>
          ...
          <div className={styles.modalContent} onClick={handleModal}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-around" }}>
                ...
                <p className={styles.plus} onClick={increaseGuests}>
                  +
                </p>
              </div>
              ...
              >
                ...
                <p className={styles.plus} onClick={increase}>
                  +
                </p>
              </div>
      ...
      <NoticeModal
        toggle={modalState}
        hide={() => openModal(getId)}
        action={() => handleDelete(getId)}
