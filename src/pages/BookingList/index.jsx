        ...
        <>
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                ...
                <button 
                    ...
                    style={{ width: '25%', marginTop: '2.2rem', padding: '1.2rem'}} 
                    onClick={() => location.href = "/bookInAdvanced"}
                >
                    Book in advanced
                </button>
            </div>
                ...
                data && data.filter((value) => keys.some((key) => value[key].toLowerCase().includes(query))).map((values, index) => (
                    <div className={styles.contentGrid} key={index}>
                        ...
                        <div className={styles.alignItems}>
                            ...
                            {/* <p style={{ fontWeight: "bold", marginTop: "4.3rem" }}>{} Adult(s)</p>
                            <p style={{ fontWeight: "bold", marginTop: "4.3rem" }}>{} Children</p> */}
                        </div>
